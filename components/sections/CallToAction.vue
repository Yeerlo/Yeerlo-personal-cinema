                    ...
                    <div class="mx-auto max-w-md sm:max-w-xl pt-10">
                        <form action="" class="flex items-center relative gap-x-2">
                            <input type="email" placeholder="johndoe@gmail.com"
                                ...
                                :style="{ borderColor: inputFocus ? subscribeText.color : '' }" v-on:focus="handleFocus"
                            ...
                            <div
                                ...
                                <button
                                    ...
                                    <span
                                        ...
                                        :style="{ backgroundColor: subscribeText.color, borderColor: subscribeText.color }"></span>
...
const { subscribeText } = defineProps(['subscribeText']);
