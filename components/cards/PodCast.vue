...
<script  setup>
const { title, href, duration, coverImage, category, createdAt, description, siteColor } = defineProps(['title', 'href', 'duration', 'coverImage', 'category', 'createdAt', 'description', 'siteColor']);
